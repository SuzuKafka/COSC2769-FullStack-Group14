  ...
  const [vendor, shipper, customer] = await User.insertMany([
    {
      ...
      role: 'vendor',
      profileImagePath: '/uploads/vendor-avatar.png',
      vendorProfile: {
    ...
    },
    {
      ...
      passwordHash: password,
      role: 'shipper',
      profileImagePath: '/uploads/shipper-avatar.png',
      shipperProfile: {
    ...
    },
    {
      ...
      passwordHash: password,
      role: 'customer',
      profileImagePath: '/uploads/customer-avatar.png',
      customerProfile: {
        name: 'Customer Demo',
  ...
  const products = [
    {
      ...
      price: 29.5,
      vendor: vendor._id,
      imagePath: '/uploads/organic-cotton-tee.jpg',
      category: 'Clothing',
    ...
    },
    {
      ...
      price: 54.0,
      vendor: vendor._id,
      imagePath: '/uploads/recycled-alu-riser.jpg',
    ...
    },
    {
      ...
      price: 32.0,
      vendor: vendor._id,
      imagePath: '/uploads/bamboo-picnic-set.jpg',
    ...
    },
    {
      ...
      price: 26.5,
      vendor: vendor._id,
      imagePath: '/uploads/upcycled-wood-box.jpg',
      category: 'Outdoor',
    ...
    },
    {
      ...
      price: 18.5,
      vendor: vendor._id,
      imagePath: '/uploads/recycled-plastic-bin.jpg',
      category: 'Home & Living',
    ...
    },
    {
      ...
      price: 17.5,
      vendor: vendor._id,
      imagePath: '/uploads/fair-coffee-beans.jpg',
      category: 'Grocery',
